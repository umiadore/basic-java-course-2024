package classwork26.example02;

public class MyLinkedList {
    private Node first; // ссылка нашего связного списка
    private Node last;
    private int size;
    ...
    public void add (String value){
        ...
        if (size ==0){
            first = newNode;
            last = newNode;
            size = 1; // равен 1 потому что  у нас всего один элемент
            return;
        }
    ...
    private static class Node { // "Node" в контексте информационных технологий часто относится к элементу или узлу в графе или сети, который может иметь соединения с другими узлами.
